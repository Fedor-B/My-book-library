...
Основная цель данного документа состоит в том, чтобы описать план тестирования десктопного приложения "Моя библиотека". Эта информация предназначена для команды, которая будет тестировать данное программное обеспечение на соответствие.
...
3. Просмотр книги
4. Изменение книги
5. Просмотр админом приватной библиотеки

Также необходимо проверить соответствие системы:
1. Авторизация
2. Просмотр гостем общей библиотеки
3. Наличие одного админа в программе
...
Результаты тестирования представлены в документе [Test](https://github.com/Fedor-B/My-book-library/blob/master/Test/Test.md).
