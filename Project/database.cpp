...
void DataBase::connectToDataBase()
{
     ...
     * */
    if(!QFile("D:/WorkSpace/5sem/QTProjects/projectOne/projectOne/" DATABASE_NAME).exists()){
...
bool DataBase::openDataBase()
{
    ...
    db.setDatabaseName("D:/WorkSpace/5sem/QTProjects/projectOne/projectOne/" DATABASE_NAME);
    if(db.open()){
        return true;
    } else {
        return false;
